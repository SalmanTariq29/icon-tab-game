...
// class TotalLifes extends StatelessWidget {

//   const TotalLifes({super.key,required this.remainingLifes});
...
//     return Row(
//       mainAxisAlignment: MainAxisAlignment.end,
//       children: [for(var i = 1; i <= 6; i++) if(i <= remainingLifes) Icon(Icons.favorite,color: Colors.red,) else Icon(Icons.favorite_border) ],
//     );
//   }
// }

// class MainBody extends StatefulWidget {
//   const MainBody({super.key,required this.onCorrect,required this.onWrong,});
...
//       mainAxisAlignment: MainAxisAlignment.spaceAround,
//       children: [
//       for(var i = 0; i < 7; i++) if(icons[i] == Icons.favorite) FloatingActionButton(onPressed: (){widget.onCorrect();},child: Icon(icons[i]),) 
//       else FloatingActionButton(onPressed: (){widget.onWrong();},child: Icon(icons[i]),) 
//       ],
//     );
//   }
// }